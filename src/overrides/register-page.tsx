      ...
      <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <section className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch">
          <div className="rounded-3xl bg-[#0f1c4d] p-10 text-white shadow-xl">
            ...
            <h1 className="mt-6 text-4xl font-bold tracking-tight">Join Cooltapas</h1>
            <p className="mt-4 text-sm leading-8 text-slate-200">
              Create a free curator account and start saving the web you love.
            </p>
            <ul className="mt-8 space-y-3">
              {[
                'Free forever — no credit card required',
                'Private bookmarks by default',
                'Build collections and grow followers',
                'Discover what curators in your niche save',
              ].map((item) => (
          ...
          <div className="rounded-3xl bg-white p-10 shadow-md ring-1 ring-slate-200">
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#1d3aa6]">Create account</p>
            <h2 className="mt-2 text-2xl font-bold text-slate-900">Get started in seconds</h2>
            ...
            <form className="mt-8 grid gap-4" onSubmit={onSubmit}>
              ...
              <label className="block">
                <span className="text-sm font-semibold text-slate-700">What do you bookmark? (optional)</span>
                <input
                  value={interests}
                  onChange={(e) => setInterests(e.target.value)}
                  className="mt-2 h-12 w-full rounded-xl border border-slate-300 bg-white px-4 text-sm outline-none focus:border-[#1d3aa6] focus:ring-2 focus:ring-[#1d3aa6]/20"
                  placeholder="Design, productivity, travel…"
                />
              </label>
            ...
            <div className="mt-6 flex items-center justify-between text-sm text-slate-600">
              ...
              <Link href="/login" className="inline-flex items-center gap-2 font-semibold text-[#1d3aa6] hover:underline">
